...
export class GiphyServicesService {
  ...
  */
  ...
  displayGifs(){
    return this.http.get<any>("https://api.giphy.com/v1/gifs/search?api_key=bF6FWo81vSpoc7d8XFDBKJ7GHDxFFNkB&q=abcdefghijklmnopqrstuvwxyz&limit=25&offset=0&rating=g&lang=en")
  }
